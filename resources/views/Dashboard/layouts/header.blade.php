                            ...
                            <li class="nav-item dropdown  ">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="index.html" class="dropdown-item ai-icon">
                                        ...
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" class="text-success"
                                            width="18" height="18" x="0" y="0" viewBox="0 0 24 24"
                                            style="enable-background:new 0 0 512 512" xml:space="preserve"
                                            class="">
                                            <g>
                                                <path
                                                    d="M13.5 10h2v.8c.7-.5 1.5-.7 2.3-.8.8 0 1.6.1 2.3.5s1.3 1 1.7 1.7.6 1.5.6 2.3V20h-2v-5.5c0-1.4-1.2-2.5-2.5-2.5s-2.5 1.1-2.5 2.5V20h-2V10zm-2-6v2h-8v5h8v2h-8v5h8v2h-10V4z"
                                                    fill="#d21818" opacity="1" data-original="#000000"
                                                    class=""></path>
                                            </g>
                                        </svg>
